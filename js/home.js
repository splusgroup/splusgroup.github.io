...
$(document).ready(function(){
	...
	function Second(){
			$("#text").html("<span style='color:#606060; font-size: 40px; text-align: left; float: left;'><strong>An active retirement lifestyle should improve with time - <span style='color: #BFBFBF'>safe </span> and <span style='color: #BFBFBF'>sustainable </span> at <span style='color: #F79646'>home</span>.</strong></span>");
